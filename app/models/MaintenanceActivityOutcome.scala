...
object MaintenanceActivityOutcomes extends NamedEntities[MaintenanceActivityOutcomeTrait, MaintenanceActivityOutcome, MaintenanceActivityOutcomePersisted]("DeviceTypes", "device_types_name_key") {
